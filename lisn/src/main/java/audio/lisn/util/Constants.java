...
public class Constants {
	public static final String PREFS_NAME = "audio.lisn.press_name";
	public static final String USER_NAME = "audio.lisn.user_name";
    ...
    public static final String PLAYER_STATE_STOP = "audio.lisn.audio.event_stop";
    public static final String PLAYER_STATE_NEXT_CHAPTER = "audio.lisn.audio.event_next";
    ...
    public static final String BOOK_ID = "audio.lisn.book_id";
    ...
    public static final int RESULT_SERVER_ERROR = 60;
