...
/**
 * Created by Rasika on 10/14/15.
 */
public class EllipsizingTextView extends TextView {
    private String ELLIPSIS = "'''";

    public void setEllipsized(String ellipsized){
        this.ELLIPSIS=ellipsized;
    }
    ...
    private Layout createWorkingLayout(String workingText) {
        return new StaticLayout(workingText, getPaint(), getWidth()
                - getPaddingLeft() - getPaddingRight(), Layout.Alignment.ALIGN_NORMAL,
